...
- Create an empty game object called "RightWallCheck"as a child of the character and position it to the left-center of the collider.
- Drag and drop this RightWallCheck object to the Ground Wall Check field of the Movement component.
